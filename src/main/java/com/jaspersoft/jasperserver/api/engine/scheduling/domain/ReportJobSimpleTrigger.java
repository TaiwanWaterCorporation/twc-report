 ...
 * moment, or for jobs that need to fire several times at fixed intervals. The
 * intervals can be specified in minutes, hours, days (equivalent to 24 hours)
 * and weeks (equivalend to 7 days).
 * </p>
 * 
 * @author Lucian Chirita (lucianc@users.sourceforge.net)
 * @version $Id: ReportJobSimpleTrigger.java 22538 2012-03-14 19:14:36Z ichan $
 * @since 1.0
 */
@XmlRootElement(name = "simpleTrigger")
public class ReportJobSimpleTrigger extends ReportJobTrigger implements
		Serializable {
	 ...
	 * 
	 * <p>
	 * A day is equivalent to 24 hours. Daylight saving time does not affect the
	 * job recurrence, therefore a job that recurs at an interval specified in
	 * days can occur at different hours after a DST hour shift.
	 * </p>
	 * 
	 * @see #getRecurrenceIntervalUnit()
	 */
	 ...
	 * 
	 * <p>
	 * If the job should be executed once, <code>1</code> should be used. If the
	 * job should recur indefinitely, {@link #RECUR_INDEFINITELY} should be
	 * used.
	 * </p>
	 * 
	 * <p>
	 ...
	 *            how many times the job should occur
	 * @see ReportJobTrigger#getEndDate()
	 */
	 ...
	 *         <code>INTERVAL_*</code> constants, or <code>null</code> if no
	 *         recurrence set
	 * 
	 ...
	 *            the unit in which the recurrence interval is defined, as one
	 *            of the <code>INTERVAL_*</code> constants
	 ...
	 */
	public void setRecurrenceIntervalUnit(byte recurrenceInterval) {
		setRecurrenceIntervalUnit(Byte.valueOf(recurrenceInterval));
	}

	/**
	 * Returns the time interval at which the trigger should fire. The interval
	 ...
	 * 
	 * @param recurrenceInterval
	 *            the job recurrence time interval
	 * @see #setRecurrenceIntervalUnit(byte)
	 */
	...
	public void setRecurrenceInterval(int recurrenceInterval) {
		setRecurrenceInterval(Integer.valueOf(recurrenceInterval));
	}
	...
	public boolean ifEquals(ReportJobTrigger rjt) {
		...
		return super.ifEquals(rjt)
				...
				&& ((this.recurrenceInterval == null && rjst
						.getRecurrenceInterval() == null) || (this.recurrenceInterval != null
						&& rjst.getRecurrenceInterval() != null && this.recurrenceInterval
							.equals(rjst.getRecurrenceInterval())))
				&& ((this.recurrenceIntervalUnit == null && rjst
						.getRecurrenceIntervalUnit() == null) || (this.recurrenceIntervalUnit != null
						&& rjst.getRecurrenceIntervalUnit() != null && this.recurrenceIntervalUnit
							.equals(rjst.getRecurrenceIntervalUnit())));
	}
