 ...
 * @version $Id: ReportJobTrigger.java 22538 2012-03-14 19:14:36Z ichan $
...
public abstract class ReportJobTrigger implements Serializable {
	...
	/**
	 * Start type that indicates that the job should be scheduled to start at
	...
	public static final int JS_MISFIRE_INSTRUCTION_NOT_SET = 0; // this is JS
																// specific code
																// for 'NO
																// VALUE'.
																// Unfortunately
	...
	public static final int JS_MISFIRE_INSTRUCTION_SMART_POLICY = -999; // the
																		// Quartz
																		// value
																		// for
																		// this
	 ...
	 * 
	 * <p>
	 * The ID needs to be set when updating a report job, but not when saving a
	 * new job.
	 * </p>
	 * 
	 * @param id
	 ...
	 * 
	 * <p>
	 * The version is automatically set when the trigger is retrieved (along
	 * with the job) from the scheduling service.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * The version doesn't have to be set when saving a new report job, but it
	 * needs to be set when updating a report job (along with its trigger).
	 * </p>
	 * 
	 * @param version
	 *            the persistent trigger version
	 */
	 ...
	 * 
	 * <p>
	 * The start date can be <code>null</code> when the trigger start type is
	 * set to <code>START_TYPE_NOW</code>.
	 * </p>
	 * 
	 ...
	 * 
	 * @param startDate
	 *            the date at which the report job should start.
	 * @see #getStartDate()
	 * @see #START_TYPE_SCHEDULE
	 */
	...
	/**
	 * Determines whether the job should be scheduled to start immediately, or
	...
	/**
	 * Specify whether the job should be scheduled to start immediately, or at
	 * the specified start date.
	 * 
	 * <p>
	 ...
	 * 
	 * @param startType
	 *            one of {@link #START_TYPE_NOW} and
	...
	/**
	 * Returns the timezone according to which the trigger date/time values are
	 * interpreted.
	 * 
	 * <p>
	 ...
	 * 
	 * @return null if there is no associated Calendar. Specified by:
	...
	public boolean ifEquals(ReportJobTrigger rjt) {
		return (this.startType == rjt.getStartType())
				&& this.timezone.equals(rjt.getTimezone())
				&& (((this.calendarName == null) && (rjt.getCalendarName() == null)) || ((this.calendarName != null)
						&& (rjt.getCalendarName() != null) && (this.calendarName
						.compareTo(rjt.getCalendarName()) == 0)))
				&& (((this.startDate == null) && (rjt.getStartDate() == null)) || ((this.startDate != null)
						&& (rjt.getStartDate() != null) && (this.startDate
						.compareTo(rjt.getStartDate()) == 0)))
				&& (((this.endDate == null) && (rjt.getEndDate() == null)) || ((this.endDate != null)
						&& (rjt.getEndDate() != null) && (this.endDate
						.compareTo(rjt.getEndDate()) == 0)))
	...
	public ReportJobTrigger(ReportJobTrigger jobTrigger) {
		// skip getId() id is generated on persistence
