 ...
 * @version $Id: OutputFormatXmlAdapter.java 22756 2012-03-23 10:39:15Z sergey.prilukin $
 */
public class OutputFormatXmlAdapter extends XmlAdapter<ReportJobOutputFormatsWrapper, Set<Byte>> {
    ...
    private static final class SingleOutputFormatAdapter extends AbstractEnumXmlAdapter<Byte> {
        @Override
